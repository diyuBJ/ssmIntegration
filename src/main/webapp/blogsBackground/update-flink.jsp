                ...
                <form action="/Flink/update" method="post" class="add-flink-form" autocomplete="off" draggable="false">
                    <div class="col-md-9">
                        ...
                        <div class="add-article-box">
                            ...
                            <div class="add-article-box-content">
                                <input type="text" id="flink-imgurl" name="imgurl" class="form-control" value="http://www.ylsat.com/images/log.png" placeholder="在此处输入图像地址" required autocomplete="off">
